...
class AiResolver
{
     ...
     */
    public function resolve(AiScope $scope): array
    {
        $configKey = $this->configKey();

        $primary = config("{$configKey}.scopes.{$scope->value}")
     ...
     */
    public function resolveUsing(AiScope $scope): array
    {
        $configKey = $this->configKey();
    ...
    {
        return config('ai-bridge.ai_config_key', 'ai-bridge.ai');
    }
